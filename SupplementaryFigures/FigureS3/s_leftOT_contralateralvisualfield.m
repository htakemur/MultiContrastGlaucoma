function s_leftOT_contralateralvisualfield
%This code aims to calculate correlation coefficient between tissue properties of the left optic tract and visual field test results in the contralateral visual field as described in the following paper:
...
icvf_control_avg = icvf_1_control_lh;
icvf_glaucoma_avg = icvf_1_glaucoma_lh;
odi_control_avg = odi_1_control_lh;
odi_glaucoma_avg = odi_1_glaucoma_lh;
fiso_control_avg = fiso_1_control_lh;
fiso_glaucoma_avg = fiso_1_glaucoma_lh;
qt1_control_avg = qt1_control_lh;
qt1_glaucoma_avg = qt1_glaucoma_lh;
...
visualfield = profile.visualfield_rightvisualfield(31:47);
