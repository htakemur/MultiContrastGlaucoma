function s_figure5_OR
%This code aims to reproduce panel B of Figure 5 in the following paper.
...
scatter(transpose(glaucoma_icvf_individual), transpose(glaucoma_qt1_individual),'Marker','o','MarkerEdgeColor','k', 'MarkerFaceColor','none');
xlim([-6 6]);
ylim([-6 6]);
xtick = [-6 0 6];
ytick = [-6 0 6];
...
ylabel('qT1 (s.d. from control mean)');
axis square
